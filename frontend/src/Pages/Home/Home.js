...
const Home = () => {
  ...
  // const RecentTransactionAmount = transactions.map((transaction, i) => {
  //   if (i === rIndex) return transaction.amount;
  // });
  ...
  return (
    <>
      ...
      <div className="row ms-5 me-5  ">
        <div className="offset-lg-3  col-lg-3 col-md-6 mb-4 text-center">
